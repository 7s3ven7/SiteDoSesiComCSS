...
<body>
    ...
    <details class="details-all">
        ...
        <form action="../../PHP/aluno/nota_receb.php">
    ...
    <div class="caixa">
        <form method="POST" action="../../PHP/Aluno/qualitativo.php">
            <table class="tabela-qualitativo">
                <tr>
                    <td>Número do pedido:</td>
                <tr>
                    <td colspan="4"><input class="qualitativo-botao" type="number" placeholder="01234" name="n_pedido"
                            name="sinopse">
                    </td>
                </tr>
            </table>
