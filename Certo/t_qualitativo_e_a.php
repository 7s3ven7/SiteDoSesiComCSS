...
<body>
    ...
    <div class="caixa-tela-informacao-geral">
            <form action="t_qualitativo_e_a.php?nome=<?php redirect()?>" method="POST">
                ...
                echo '
                <form method="POST" action="t_qualitativo_e_a.php?nome=">
...
for($i = 1;$i<=20;$i+= 1){ $numero='v' .$i; if(isset($_POST[$i])){ $valor='$' .$numero; $$valor='V';
    echo $valor.'='.$$valor.' <br>';
    $numero='';
    ...
    $SQL = 'INSERT INTO `qualitativo_e_a`
