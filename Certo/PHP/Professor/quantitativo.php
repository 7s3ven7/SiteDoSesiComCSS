...
if ($conexao->connect_errno) {
    ...
    $SQL = 'INSERT INTO `quantitava_recebimento_p` (`cod_inter`,`cod_forne`,`nome_empre`,`CNPJ_empre`,`modelo_conta`,`navio`,`nome_dest`,`tipo_container`,`lacre`,`lacre_SIF`,`temperatura`,`IMO`,`n_ONU`,`nome_prod`,`und`,`quant_produto`,`quant_und`,`lote`,`CNPJ_dest`,`n_nota`) 
