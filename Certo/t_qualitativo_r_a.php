...
<div class="caixa-tela-informacao-geral">
    <form action="t_qualitativo_r_a.php" method="POST">
        <center>
            <div class="texto-grande-qualitat">
                ...
                <table class="tabela-qualitat">
                    <tr>
                        <td class="td-qualitat">
                            <div class="texto-pequeno-qualitat">Código do fornecedor:
                        </td>
                        <td class="td-qualitat">'.$row['cod_forne'].'
=======
    <div class="caixa-tela-informacao-geral">
                <form action="t_qualitativo_r_a.php" method="POST">
...
>>>>>>> 03532b75924050821cd179bf4c3fea8962e3c634
            </div>
            </td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Lotes: </div>
                </td>
                <td class="td-qualitat">'.$row['lote'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Nome da empresa: </div>
                </td>
                <td class="td-qualitat">'.$row['nome_e'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">CNPJ da empresa: </div>
                </td>
                <td class="td-qualitat">'.$row['CNPJ_f'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Modelo do container: </div>
                </td>
                <td class="td-qualitat">'.$row['modelo_contai'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Navio: </div>
                </td>
                <td class="td-qualitat">'.$row['navio'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Destinatário: </div>
                </td>
                <td class="td-qualitat">'.$row['CNPJ_f'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Tipo do container: </div>
                </td>
                <td class="td-qualitat">'.$row['tipo_contai'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Lacre: </div>
                </td>
                <td class="td-qualitat">'.$row['lacre'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Lacre SIF: </div>
                </td>
                <td class="td-qualitat">'.$row['lacre_SIF'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Temperatura: </div>
                </td>
                <td class="td-qualitat">'.$row['temperatura'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">IMO: </div>
                </td>
                <td class="td-qualitat">'.$row['IMO'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Número ONU: </div>
                </td>
                <td class="td-qualitat">'.$row['n_ONU'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Nome do produto: </div>
                </td>
                <td class="td-qualitat">'.$row['nome_p'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Unidades:
                </td>
                <td class="td-qualitat">'.$row['und'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Quantidade de produto: </div>
                </td>
                <td class="td-qualitat">'.$row['quant_prod'].'</td>
            </tr>
            <tr>
                <td class="td-qualitat">
                    <div class="texto-pequeno-qualitat">Quantidade de unidade: </div>
                </td>
                <td class="td-qualitat">'.$row['quant_und'].'</td>
            </tr>
            </table>
...
<div class="caixa-qualitat-2">
    <table class="tabela-qualitat2">
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Container Bem Desgastado: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="1">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Avaria na Lateral Direita: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="2">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Avaria na Lateral Esquerda: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="3">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Avaria no Teto: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="4">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Avaria na Frente: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="5">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Sem Lacre </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="6">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Adesivos Avariados: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="7">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Excesso de Altura: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="8">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Excesso na Direita: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="9">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Excesso na Esquerda: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="10">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Excesso Frontal: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="11">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Painel Avariado: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="12">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Sem Cabo de Energia: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="13">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Sem Lona: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="14">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Canhoto Assinado: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="15">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Volume Correto: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="16">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Atraso: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="17">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Código Avariado: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="18">
        ...
        <tr>
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Item Lacrado: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="19">
            ...
            <td class="td-qualitat">
                <div class="texto-pequeno-qualitat">Doca 1: </div>
            </td>
            <td class="td-qualitat">
                <label class="container-qualitat">
                    <input class="check-qualitat" type="checkbox" name="20">
