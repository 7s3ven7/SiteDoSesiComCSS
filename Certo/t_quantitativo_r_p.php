...
<div class='caixa-menu-geral'>
    ...
    <div class="caixa-principal-quantitativo-r-p">
        ...
        <div class="caixa-principal2-quantitativo-r-p">
            <form method="POST" action="t_quantitativo_r_p.php">
            <table class="">
                <tr>
                    <td class="texto-central-quantitativo-r-p">Código do fornecedor: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="1" placeholder="1234"></td>
                    <td class="texto-central-quantitativo-r-p">Nome da empresa: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="2" placeholder="Aplle"></td>
                </tr>
                <tr>
                    <td class="texto-central-quantitativo-r-p">Modelo do container: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="3" placeholder="SENU-123456-2"></td>
                    <td class="texto-central-quantitativo-r-p">Navio: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="4" placeholder="Titanaique"></td>
                </tr>
                <tr>
                    <td class="texto-central-quantitativo-r-p">Nome do fornecedor: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="5" placeholder="Aplle"></td>
                    <td class="texto-central-quantitativo-r-p">Tipo do container: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="6" placeholder="2201"></td>
                </tr>
                <tr>
                    <td class="texto-central-quantitativo-r-p">Lacre: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="7" placeholder="Lacre"></td>
                    <td class="texto-central-quantitativo-r-p">Lacre SIF: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="8" placeholder="SIF"></td>
                </tr>
                <tr>
                    <td class="texto-central-quantitativo-r-p">Temperatura: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="9" placeholder="Temperatura"></td>
                    <td class="texto-central-quantitativo-r-p">IMO: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="10" placeholder="IMO"></td>
                </tr>
                <tr>
                    <td class="texto-central-quantitativo-r-p">Número ONU: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="11" placeholder="Número"></td>
                    <td class="texto-central-quantitativo-r-p">Lotes: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="12" placeholder="A1"></td>
                </tr>
                <tr>
                    <td class="texto-central-quantitativo-r-p">CNPJ do destinatário: </td>
                    <td><input class="botao-central-escrever-quant" type="text" name="13" placeholder="CNPJ"></td>
                </tr>
            </table>
        </form>
        </div>
    <input class="botao-central-enviar-quant" type="submit" value="Enviar" name="enviar">
    </center>
 </div>
